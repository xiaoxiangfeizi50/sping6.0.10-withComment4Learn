...
public abstract class AbstractAspectJAdvisorFactory implements AspectJAdvisorFactory {
	...
	/**
	 * 判断是否是AspectJ编译的类，就判断ajc$开头的字段
	 * We consider something to be an AspectJ aspect suitable for use by the Spring AOP system if it has the @Aspect annotation, and was not compiled by ajc. The reason for this latter test
	...
	/**
	 * 过滤注解：Pointcut.class, Around.class, Before.class, After.class, AfterReturning.class, AfterThrowing.class
	...
	/** 过滤器注解：Point Around Before After AfterReturning AfterThrowing*/
	@Nullable
