...
class ConfigurationClassBeanDefinitionReader {
	...
	private void loadBeanDefinitionsForConfigurationClass(
		...
		// 调用实现类ImportBeanDefinitionRegistrar（各种@EnableXX注解会走这里进行实现，例如AOP，事务），解析@Import注解
	...
	private void loadBeanDefinitionsForBeanMethod(BeanMethod beanMethod) {
		...
		System.out.println("@Configuration方式注册bean定义：" + beanName);
		if (logger.isTraceEnabled()) {
	...
	/** 调用实现类ImportBeanDefinitionRegistrar（各种@EnableXX注解会走这里进行实现，例如AOP，事务）*/
